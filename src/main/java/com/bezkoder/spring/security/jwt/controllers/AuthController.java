...
public class AuthController {
  ...
  public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
    ...
    return ResponseEntity.ok(new JwtResponse(userDetails.getWard(), userDetails.getCreatedAt(), userDetails.getUpdatedAt(), userDetails.getName(), userDetails.getBirthday(), userDetails.getGender(), userDetails.getAddress(), userDetails.getStatus(), userDetails.getPhone(), jwt, refreshToken.getToken(), userDetails.getId(),
