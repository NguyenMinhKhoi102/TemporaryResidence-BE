...
public class CT05 {
    ...
    public Map<String, Object> initParameters(){
        ...
        parameters.put("additionalFile", this.additionalFile);
        parameters.put("declareAgain", this.declareAgain);
        parameters.put("otherInstructions", this.otherInstructions);
        parameters.put("reason", this.reason);
        parameters.put("phoneOrgan", this.phoneOrgan);
